  ...
  return (
    <div className="p-6 space-y-6 bg-gray-900">
      ...
      <Link to="/transactions">
          <button className="bg-blue-600 text-white px-4 ml-3 mb-2 py-2 rounded hover:bg-blue-700">
            Add Transaction
          </button>
        </Link>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="p-4 border bg-blue-100 rounded">
